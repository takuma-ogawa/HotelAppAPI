...
namespace HotelAppAPI.Models
{
    ...
    public partial class T_StayFictitiousAccountPlanProducts
    {
        public int StayFictitiousAccountPlanProductID { get; set; }
        public Nullable<int> StayReservationBasicID { get; set; }
        public Nullable<int> StayFictitiousAccountBasicID { get; set; }
        public Nullable<int> StayFictitiousAccountBasicDetailID { get; set; }
